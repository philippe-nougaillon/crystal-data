...
(function() {
  $(function() {
    return $('#pop-lg1').on('click', function() {
      $('#imagepreview-lg').attr('src', $('#imageresource-lg1').attr('src'));
      return $('#imagemodal-lg').modal('show');
    });
  });

  $(function() {
    return $('#pop-lg2').on('click', function() {
      $('#imagepreview-lg').attr('src', $('#imageresource-lg2').attr('src'));
      return $('#imagemodal-lg').modal('show');
    });
  });

  $(function() {
    return $('#pop-lg3').on('click', function() {
      $('#imagepreview-lg').attr('src', $('#imageresource-lg3').attr('src'));
      return $('#imagemodal-lg').modal('show');
    });
  });

  $(function() {
    return $('#pop-lg4').on('click', function() {
      $('#imagepreview-lg').attr('src', $('#imageresource-lg4').attr('src'));
      return $('#imagemodal-lg').modal('show');
    });
  });

  $(function() {
    return $('#pop-lg5').on('click', function() {
      $('#imagepreview-lg').attr('src', $('#imageresource-lg5').attr('src'));
      return $('#imagemodal-lg').modal('show');
    });
  });

  $(function() {
    return $('#pop-lg6').on('click', function() {
      $('#imagepreview-lg').attr('src', $('#imageresource-lg6').attr('src'));
      return $('#imagemodal-lg').modal('show');
    });
  });

  $(function() {
    return $('#pop-lg7').on('click', function() {
  ...
  $(function() {
    return $('#pop-lg8').on('click', function() {
  ...
  $(function() {
    return $('#pop-sm1').on('click', function() {
      $('#imagepreview-sm').attr('src', $('#imageresource-sm-1').attr('src'));
      return $('#imagemodal-sm').modal('show');
    });
  });

  $(function() {
    return $('#pop-sm2').on('click', function() {
      $('#imagepreview-sm').attr('src', $('#imageresource-sm-2').attr('src'));
      return $('#imagemodal-sm').modal('show');
    });
  });

  $(function() {
    return $('#pop-sm3').on('click', function() {
      $('#imagepreview-sm').attr('src', $('#imageresource-sm-3').attr('src'));
      return $('#imagemodal-sm').modal('show');
    });
  });
...
(function() {
  ...
  $(function() {
    return $('.sticky').stickyTableHeaders();
  });

  $(function() {
    return $('.sigPad').signaturePad({
      drawOnly: true
    });
  });

  $(function() {
    return $('.sigPad').signaturePad.clear();
  });
